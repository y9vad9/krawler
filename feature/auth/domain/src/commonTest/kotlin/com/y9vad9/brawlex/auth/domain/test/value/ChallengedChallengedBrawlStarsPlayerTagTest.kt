...
class ChallengedChallengedBrawlStarsPlayerTagTest {
    ...
    fun `creates tag with valid input without prefix`() {
        ...
        // WHEN
        val result = ChallengedBrawlStarsPlayerTag.factory.create(input)
    ...
    fun `fails on input below minimum length`() {
        ...
        assertIs<ChallengedBrawlStarsPlayerTag.CreationFailure.TagNotWithinRangeFailure>(result.error)
    }
    ...
    fun `fails on invalid format with special characters`() {
        ...
        assertIs<ChallengedBrawlStarsPlayerTag.CreationFailure.InvalidFormatFailure>(result.error)
    }
    ...
    fun `toString returns prefixed string`() {
        ...
        // WHEN
        val tag = ChallengedBrawlStarsPlayerTag.factory.create(input).getOrNull()
