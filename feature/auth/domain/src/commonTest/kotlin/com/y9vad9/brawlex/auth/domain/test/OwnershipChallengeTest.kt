package com.y9vad9.brawlex.auth.domain.test

import com.y9vad9.brawlex.auth.domain.OwnershipChallenge
import com.y9vad9.brawlex.auth.domain.OwnershipChallengeResult
import com.y9vad9.brawlex.auth.domain.event.OwnershipChallengeUpdateEvent
import com.y9vad9.brawlex.auth.domain.value.ChallengeId
import com.y9vad9.brawlex.auth.domain.value.ChallengedBrawlStarsPlayerTag
import com.y9vad9.brawlex.auth.domain.value.ChallengedUserId
import com.y9vad9.brawlex.auth.domain.value.LastFriendlyBattle
...
import com.y9vad9.brawlex.auth.domain.value.OwnershipChallengeBrawlerId
import com.y9vad9.brawlex.auth.domain.value.OwnershipChallengeEventType
import com.y9vad9.brawlex.auth.domain.value.OwnershipChallengeTimeFrame
import com.y9vad9.brawlex.auth.domain.value.OwnershipTask
