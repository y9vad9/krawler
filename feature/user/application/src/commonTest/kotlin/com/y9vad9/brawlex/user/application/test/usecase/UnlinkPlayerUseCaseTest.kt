...
import com.y9vad9.brawlex.user.application.usecase.UnlinkPlayerUseCase
...
class UnlinkPlayerUseCaseTest {
    ...
    private val playerTag = BrawlStarsPlayerTag.factory.createOrThrow("PLAYER123")
    ...
    // commented due to problems with mocking, see https://github.com/y9vad9/brawlex/issues/17
//    @Test
