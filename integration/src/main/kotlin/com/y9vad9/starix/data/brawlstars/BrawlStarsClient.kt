package com.y9vad9.starix.data.brawlstars
...
import com.y9vad9.starix.core.brawlstars.entity.event.ScheduledEvent
...
import com.y9vad9.starix.core.brawlstars.exception.ClientError
import com.y9vad9.starix.core.common.entity.value.Count
import com.y9vad9.starix.core.common.entity.value.CountryCode
import com.y9vad9.starix.data.brawlstars.pagination.Cursors
import com.y9vad9.starix.data.brawlstars.pagination.Page
import com.y9vad9.starix.data.brawlstars.pagination.PagesIterator
...
class BrawlStarsClient(
     ...
     */
    suspend fun getPlayer(tag: PlayerTag): Result<com.y9vad9.starix.core.brawlstars.entity.player.Player?> =
        getRequest(typeInfo<com.y9vad9.starix.core.brawlstars.entity.player.Player>(), "players/${tag.toString().replace("#", "%23")}")
     ...
     */
    suspend fun getClub(tag: ClubTag): Result<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club?> =
        getRequest(typeInfo<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club?>(), "clubs/${tag.toString().replace("#", "%23")}")
     ...
     */
    suspend fun getClubMembers(tag: ClubTag): Result<List<ClubMember>> = getRequest<List<ClubMember>>(
     ...
     */
    suspend fun getClubsRankings(countryCode: CountryCode = CountryCode.GLOBAL): Result<List<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club.Ranking>> {
        return getRequest<List<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club.Ranking>>(
            typeInfo = typeInfo<List<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club.Ranking>>(),
    ...
    fun getClubsRankingsLazily(
        ...
        limit: Count,
    ): PagesIterator<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club.Ranking> {
        return PagesIterator<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club.Ranking>(limit) { count, cursors ->
            getRequestListWithPagination(
                typeInfo = typeInfo<List<_root_ide_package_.com.y9vad9.starix.core.brawlstars.entity.club.Club.Ranking>>(),
                url = "rankings/${countryCode.value}/clubs",
                cursors = cursors,
     ...
     */
    suspend fun getPlayersRankings(countryCode: CountryCode = CountryCode.GLOBAL): Result<List<com.y9vad9.starix.core.brawlstars.entity.player.Player.Ranking>> {
        return getRequest<List<com.y9vad9.starix.core.brawlstars.entity.player.Player.Ranking>>(
            typeInfo = typeInfo<List<com.y9vad9.starix.core.brawlstars.entity.player.Player.Ranking>>(),
    ...
    fun getPlayersRankingsLazily(
        countryCode: CountryCode = CountryCode.GLOBAL,
        limit: Count,
    ): PagesIterator<com.y9vad9.starix.core.brawlstars.entity.player.Player.Ranking> {
        return PagesIterator<com.y9vad9.starix.core.brawlstars.entity.player.Player.Ranking>(limit) { count, cursors ->
            getRequestListWithPagination(
                typeInfo = typeInfo<List<com.y9vad9.starix.core.brawlstars.entity.player.Player.Ranking>>(),
                url = "rankings/${countryCode.value}/players",
                cursors = cursors,
