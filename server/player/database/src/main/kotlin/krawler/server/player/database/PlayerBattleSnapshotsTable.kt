 ...
 */
class PlayerBattleSnapshotsTable(json: Json, config: PlayerDatabaseConfig) : Table("player_battle_snapshots") {
    ...
    override val primaryKey: PrimaryKey = PrimaryKey(arrayOf(playerTag, battleTime))
}
