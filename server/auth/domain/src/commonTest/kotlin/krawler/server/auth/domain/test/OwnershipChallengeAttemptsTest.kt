...
class OwnershipChallengeAttemptsTest {
    ...
    fun `should compare attempts correctly`() {
        // GIVEN
        val lower = OwnershipChallengeAttempts.createOrThrow(int = 2)
        val higher = OwnershipChallengeAttempts.createOrThrow(int = 4)
        val same = OwnershipChallengeAttempts.createOrThrow(int = 2)
