...
import krawler.server.auth.domain.OwnershipChallengeBotsAmount.Companion.MAX_VALUE
import krawler.server.auth.domain.OwnershipChallengeBotsAmount.Companion.MIN_VALUE
import krawler.server.auth.domain.OwnershipChallengeBotsAmount.Companion.create
import krawler.server.auth.domain.OwnershipChallengeBotsAmount.Companion.createOrNull
import krawler.server.auth.domain.OwnershipChallengeBotsAmount.Companion.createOrThrow
