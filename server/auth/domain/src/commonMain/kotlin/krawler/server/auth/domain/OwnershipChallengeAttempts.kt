...
import krawler.server.auth.domain.OwnershipChallengeAttempts.Companion.create
import krawler.server.auth.domain.OwnershipChallengeAttempts.Companion.createOrNull
import krawler.server.auth.domain.OwnershipChallengeAttempts.Companion.createOrThrow
