...
import krawler.auth.domain.OwnershipChallengeBotsAmount.Companion.MAX_VALUE
import krawler.auth.domain.OwnershipChallengeBotsAmount.Companion.MIN_VALUE
import krawler.auth.domain.OwnershipChallengeBotsAmount.Companion.create
import krawler.auth.domain.OwnershipChallengeBotsAmount.Companion.createOrNull
import krawler.auth.domain.OwnershipChallengeBotsAmount.Companion.createOrThrow
